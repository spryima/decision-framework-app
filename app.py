...
AHP_DOMAIN_COPY = {
    "economic_quality": {
        "label": "Фінанси",
        "question": "Наскільки зараз критично для тебе максимізувати дохідність, гарантувати стабільний cash flow та захистити капітал?",
        "description": "Це не про те, «чи любиш ти гроші». Це про те, чи перебуваєш ти у фазі агресивного накопичення і потреби в ліквідності. Якщо ти обереш цей пріоритет, тобі доведеться відмовлятися від красивих, перспективних чи комфортних проєктів, якщо вони не дають чіткого і швидкого фінансового результату (IRR, ROI).",
    },
    "strategic_significance": {
        "label": "Стратегія",
        "question": "Наскільки важливо для тебе (найближчі 1–2 роки) інвестувати у своє майбутнє (нові ніші, партнерства, репутацію, знання), навіть якщо це не дає швидкої фінансової віддачі?",
        "description": "Це ставка на довгострокову перевагу і «стратегічну позицію». Обравши цей пріоритет, ти погоджуєшся тримати у портфелі проєкти, які можуть бути фінансово скромними сьогодні, але створюють для тебе унікальну конкурентну перевагу, синергію з іншими бізнесами або відкривають двері в потрібні екосистеми завтра.",
    },
    "asset_controllability": {
        "label": "Керованість",
        "question": "Наскільки критично для тебе мати тверді важелі впливу, абсолютну прозорість цифр та юридичну захищеність твого капіталу?",
        "description": "Це про архітектуру влади: хто тримає штурвал і чи є у тебе «стоп-кран». Наявність компетентної команди, юридичного права вето, доступу до об’єктивного аудиту та чіткого механізму виходу. Обравши цей пріоритет, ти погоджуєшся відхиляти навіть найбільш надприбуткові пропозиції, якщо вони базуються лише на «чесному слові» і ставлять тебе у позицію безправного пасажира, який не контролює ситуацію.",
    },
    "management_load": {
        "label": "Навантаження",
        "question": "Наскільки критично для тебе зберегти час, увагу й ментальний ресурс для інших важливих напрямів?",
        "description": "Це питання альтернативної вартості. Кожна година твоєї операційної залученості та мікроменеджменту — це втрачений час для іншого бізнесу, сім’ї або відновлення. Надаючи вагу цьому критерію, ти віддаєш перевагу проєктам із високим ступенем автономії, де результат досягається завдяки архітектурі процесів та системному управлінню, а не ручному втручанню і мікроменеджменту.",
    },
    "personal_fit": {
        "label": "Особиста сумісність",
        "question": "Наскільки критично, щоб діяльність давала тобі енергію та не суперечила цінностям?",
        "description": "Це про якість енергії, а не кількість годин. Обравши цей пріоритет, ти відмовляєшся від вигідних бізнесів, якщо вони створюють моральний компроміс, внутрішній спротив або дискомфорт від людей, з якими доведеться працювати.",
    },
}
...
CRITERIA = [
    {
        ...
        "anchors": {
            "10": "Високий шанс досягти або перевищити цільові показники.",
            "7": "Віддача реалістична; невідомі змінні зрозумілі й керовані.",
            "5": "Віддача можлива, але залежить від 1–2 ключових припущень.",
            "3": "Ціль радше завищена; базовий сценарій слабко підтверджений.",
            "0": "Шансів мало; результат тримається на надії або випадковості.",
        },
    ...
    },
    {
        ...
        "domain": "economic_quality",
        "name": "Якість грошового потоку",
        "type": "scale",
        "default": 5.0,
        "what": "Передбачуваність, повторюваність, волатильність і видимість грошового потоку.",
        "anchors": {
            "10": "Грошовий потік стабільний, прогнозований і швидко надходить.",
            "7": "Потік добрий, але є сезонність або кілька слабких місць.",
            "5": "Гроші є, але потік нерівний, слабко видимий або потребує ручного контролю.",
            "3": "Потік нестабільний, рваний, із частими касовими розривами.",
            "0": "Довіри до майбутнього потоку грошей майже немає.",
        },
    ...
    },
    {
        ...
        "anchors": {
            "10": "Вийти можна швидко, дешево і майже без незворотних втрат.",
            "7": "Вихід можливий, але з дисконтом, тертям або затримкою.",
            "5": "Вийти можна, але це довго, дорого або фінансово болісно.",
            "3": "Ліквідність слабка; закриття позиції складне, дороге або залежне.",
            "0": "Пастка: вийти дуже важко або фактично неможливо.",
        },
    ...
    },
    {
        ...
        "anchors": {
            "10": "Об’єкт добре тримає удари; ризик втрат обмежений, конструкція міцна.",
            "7": "Сильний стрес переживе, але втратить темп, маржу або гнучкість.",
            "5": "Середня стійкість: слабкі місця є, але вони не критичні.",
            "3": "Один серйозний удар може сильно пошкодити об’єкт.",
            "0": "Крихка конструкція; ризик втрат непропорційно високий.",
        },
...
/* --- Streamlit chrome handling: conservative sidebar-safe mode --------
   Do not hide the Streamlit header or toolbar. The sidebar collapse/reopen
   control is rendered inside Streamlit chrome, and aggressive hiding breaks it.
   This block only normalizes colors and forces sidebar containers to stay visible. */
...
/* Keep Streamlit Cloud top-right controls usable but visually quiet. */
...
def page_welcome() -> None:
    ...
    st.markdown(
        ...
        <div class='df-outcome-card'>
          <div class='df-outcome-title'>На виході ти отримаєш</div>
